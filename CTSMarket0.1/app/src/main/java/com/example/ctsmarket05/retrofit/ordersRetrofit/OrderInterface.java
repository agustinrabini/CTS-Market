...
public interface OrderInterface {
    ...
    @DELETE("order/cartRemove/{order_id}/{user_id}/{product_id}/{products_order_id}")
    Call<Orders> removeCart(@Path("order_id") int id_product, @Path("user_id") int id_user,@Path("product_id") int product_id, @Path("products_order_id") int products_order_id);
}
